...
// Lazy-init to avoid TDZ errors in bundled output where config loading
// can trigger parseModelRef before this module's top-level consts are
// evaluated. See https://github.com/openclaw/openclaw/issues/44977
